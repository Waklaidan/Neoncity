...
GLOBAL_LIST_INIT(dye_registry, list(
	DYE_REGISTRY_UNDER = list(
		...
		DYE_MAYOR = /obj/item/clothing/under/rank/mayor,
		DYE_CC = /obj/item/clothing/under/rank/civilian/city_clerk,
		DYE_COP = /obj/item/clothing/under/rank/security/chief_of_police,
	...
	DYE_REGISTRY_JUMPSKIRT = list(
		...
		DYE_MAYOR = /obj/item/clothing/under/rank/mayor/skirt,
		DYE_CC = /obj/item/clothing/under/rank/civilian/city_clerk/skirt,
		DYE_COP = /obj/item/clothing/under/rank/security/chief_of_police/skirt,
	...
	DYE_REGISTRY_GLOVES = list(
		...
		DYE_MAYOR = /obj/item/clothing/gloves/color/mayor,
		DYE_CC = /obj/item/clothing/gloves/color/grey,
		DYE_COP = /obj/item/clothing/gloves/color/black,
	...
	DYE_REGISTRY_SNEAKERS = list(
		...
		DYE_MAYOR = /obj/item/clothing/shoes/sneakers/brown,
		DYE_CC = /obj/item/clothing/shoes/sneakers/brown,
	...
	DYE_REGISTRY_BEDSHEET = list(
		...
		DYE_MAYOR = /obj/item/bedsheet/mayor,
		DYE_CC = /obj/item/bedsheet/cc,
		DYE_COP = /obj/item/bedsheet/cop,
		...
		DYE_CC = /obj/item/bedsheet/cc/double,
		DYE_COP = /obj/item/bedsheet/cop/double,
