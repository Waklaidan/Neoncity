...
/datum/crewmonitor
	...
	var/list/jobs = list(
		...
		JOB_MAYOR = 00,
		// 10-19: Security
		JOB_CHIEF_OF_POLICE = 10,
		JOB_WARDEN = 11,
		JOB_POLICE_OFFICER = 12,
		JOB_POLICE_OFFICER_MEDICAL = 13,
		JOB_POLICE_OFFICER_ENGINEERING = 14,
		JOB_POLICE_OFFICER_SCIENCE = 15,
		JOB_POLICE_OFFICER_SUPPLY = 16,
		JOB_DETECTIVE = 17,
		// 20-29: Medbay
