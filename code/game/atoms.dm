...
/atom/proc/on_mouse_enter(client/client)
	...
	if(active_hud)
		if(!active_hud.screentips_enabled || (flags_1 & NO_SCREENTIPS_1))
			...
			active_hud.screentip_text.maptext = "<span class='maptext' style='text-align: center; font-size: 32px; text-shadow: 1px 1px 0 #000000,-1px -1px 0 #000000, 2px 2px 0 #000000,-2px -2px 0 #000000;;font-family: \"Small Fonts\"; color: [active_hud.screentip_color]'>[uppertext(name)]</span>"
