...
//The lab cage and mayor's display case do not spawn with electronics, which is why req_access is needed.
/obj/structure/displaycase/mayor
	start_showpiece_type = /obj/item/gun/energy/laser/mayor
...
/obj/structure/displaycase/trophy/attackby(obj/item/W, mob/living/user, params)
	...
	if(is_locked)
		to_chat(user, span_warning("The case is shut tight with an old-fashioned physical lock. Maybe you should ask the journalist for the key?"))
		return
...
/obj/item/key/displaycase
	...
	desc = "The key to the journalist's display cases."
