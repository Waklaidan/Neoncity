...
/obj/item/food/candy/bronx
	...
	custom_price = PAYCHECK_CIVILIAN * 1.6 //Joke adjusted for inflation
	w_class = WEIGHT_CLASS_TINY
...
/obj/item/food/no_raisin
	...
	food_flags = FOOD_FINGER_FOOD
	custom_price = PAYCHECK_CIVILIAN * 0.7
	w_class = WEIGHT_CLASS_SMALL
...
/obj/item/food/peanuts
	...
	custom_price = PAYCHECK_CIVILIAN * 0.8 //nuts are expensive in real life, and this is the best food in the vendor.
