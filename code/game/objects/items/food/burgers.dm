...
/obj/item/food/burger/plain
	...
	custom_price = PAYCHECK_CIVILIAN * 0.8
...
/obj/item/food/burger/plain/Initialize(mapload)
	...
	if(prob(1))
		...
		name = "steamed ham"
		desc = pick("Ahh, City Clerk, welcome. I hope you're prepared for an unforgettable luncheon!",
...
/obj/item/food/burger/baconburger
	...
	foodtypes = GRAIN | MEAT
	custom_premium_price = PAYCHECK_CIVILIAN * 1.6
	venue_value = FOOD_PRICE_NORMAL
