...
/obj/item/instrument/piano_synth/headphones
	...
	custom_price = PAYCHECK_CIVILIAN * 2.5
	instrument_range = 1
...
/obj/item/instrument/piano_synth/headphones/spacepods
	...
	custom_premium_price = PAYCHECK_CIVILIAN * 36 //Save up 5 shifts worth of pay just to lose it down a drainpipe on the sidewalk
