/obj/machinery/vending/toyliberationstation
	...
	icon_state = "syndi"
	panel_type = "panel18"
	product_slogans = "Get your cool toys today!;Trigger a valid hunter today!;Quality toy weapons for cheap prices!;Give them to CCs for all access!;Give them to HoS to get permabrigged!"
	...
	products = list(
		...
		/obj/item/clothing/head/syndicatefake = 5 //OPS IN DORMS oh wait it's just an civilian
	)
	contraband = list(
