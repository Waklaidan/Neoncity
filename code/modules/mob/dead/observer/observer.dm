...
/mob/dead/observer/proc/set_ghost_appearance()
	...
	if(HAIR in species.species_traits)
		...
		hair_color = brighten_color(GLOB.color_list_human_hair["[client.prefs.read_preference(/datum/preference/choiced/hair_color)]"])
	...
	if(FACEHAIR in species.species_traits)
		...
		facial_hair_color = brighten_color(GLOB.color_list_human_hair["[client.prefs.read_preference(/datum/preference/choiced/facial_hair_color)]"])
