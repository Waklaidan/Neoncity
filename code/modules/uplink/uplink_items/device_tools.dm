...
/datum/uplink_item/device_tools/fakenucleardisk
	...
	desc = "It's just a normal disk. Visually it's identical to the real deal, but it won't hold up under closer scrutiny by the Mayor. \
...
/datum/uplink_item/device_tools/frame
	...
	desc = "When inserted into a personal digital civilian, this cartridge gives you five PDA viruses which \
