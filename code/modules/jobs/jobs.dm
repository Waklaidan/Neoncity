...
/proc/get_full_job_name(job)
	...
	var/static/regex/cop_expand = new("cop")
	var/static/regex/cc_expand = new("cc")
	var/static/regex/rd_expand = new("rd")
	var/static/regex/ce_expand = new("ce")
	var/static/regex/qm_expand = new("qm")
	var/static/regex/sec_expand = new("(?<!police )officer")
	...
	job = cop_expand.Replace(job, "chief of police")
	job = cc_expand.Replace(job, "city clerk")
