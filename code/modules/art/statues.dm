...
/obj/structure/statue/custom/unique_vars_to_save()
	return list("greyscale_with_value_bump")
...
/obj/structure/statue/custom/get_image_for_saving() // used for image saving
	if(!content_ma)
		return ..()

	return getCompoundIcon(content_ma.appearance)

/obj/structure/statue/custom/restore_persistent_image(overwrite_image_id = null)
	var/icon/I = ..()
	if(!I)
		return
	content_ma = new
